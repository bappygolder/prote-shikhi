...
You are reading this because you are **Claude Code**. Other AI tools on this project read sibling files:
...
See `~/.claude/shared/MODEL-GUIDE.md` for the full table.

| Task | Model | Model ID |
|---|---|---|
| Architecture decisions, hard bugs | Opus 4.6 | `claude-opus-4-6` |
| Feature implementation (default) | Sonnet 4.6 | `claude-sonnet-4-6` |
| Small edits, quick lookups | Haiku 4.5 | `claude-haiku-4-5-20251001` |
